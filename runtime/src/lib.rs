...
use sp_runtime::traits::{
    AccountIdLookup, BlakeTwo256, Block as BlockT, NumberFor, OpaqueKeys, Verify,
};
use sp_runtime::{
...
pub mod opaque {
    use super::*;
    pub use node_primitives::{Block, BlockId, Header};
...
impl_runtime_apis! {
    ...
    impl pallet_contracts_rpc_runtime_api::ContractsApi<
        Block, AccountId, Balance, BlockNumber,
    >
        for Runtime
    {
        fn call(
